...
import ZnpDataItemPrisadka from "./znpData_item_Prisadka";

const ZnpDataTablePrisadka = observer(() => {
...
//===================== Блок с переменными ========================================
    ...
    useEffect(()=>{
       if (globalStore.znp.id != "") {
           ...
           getAllZnpData(globalStore.znp.id, user.prisadka)
            ...
            <table className={classes.tableData}>
                ...
                {globalStore.znpFilter == true ?(
                    sortedZnpData.map((worckZnpDat) =>
                        (
                            <ZnpDataItemPrisadka buffers={buffers} znpData={worckZnpDat} specZapros={specZopros} modalDatas={modalDatas} stanckiSpisock={stanckiSpisock}  key={worckZnpDat.id}  />
                        )
                    )
                ):(
                    <tr></tr>
...
export default React.memo(ZnpDataTablePrisadka);