...
const Stanok16Additive = ({znpData,  stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet16"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_additive_16 != null
                ? (<option value="standart">{znpData.machine_pallet_additive_16}✔</option>)
...
export default React.memo(Stanok16Additive);