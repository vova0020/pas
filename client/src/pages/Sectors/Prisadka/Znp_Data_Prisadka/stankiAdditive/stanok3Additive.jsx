...
const Stanok3Additive = ({znpData,  stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet3"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_additive_3 != null
                ? (<option value="standart">{znpData.machine_pallet_additive_3}✔</option>)
...
export default React.memo(Stanok3Additive);