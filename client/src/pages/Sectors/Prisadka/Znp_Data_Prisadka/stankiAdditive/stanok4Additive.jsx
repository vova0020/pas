...
const Stanok4Additive = ({znpData, stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet4"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_additive_4 != null
                ? (<option value="standart">{znpData.machine_pallet_additive_4}✔</option>)
...
export default React.memo(Stanok4Additive);