...
const Stanok12Additive = ({znpData, stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet12"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_additive_12 != null
                ? (<option value="standart">{znpData.machine_pallet_additive_12}✔</option>)
...
export default React.memo(Stanok12Additive);