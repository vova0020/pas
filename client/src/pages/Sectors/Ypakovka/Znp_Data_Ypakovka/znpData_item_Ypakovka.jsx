...
const ZnpDataItemYpakovka = ({buffers,specZopros,modalDatas, ...props}) => {
...
// Функция отправки статуса в работе
    async function worckStatus(e, props){
        if (e.target.className == "button_adress_1"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_1:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_2"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_2:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_3"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_3:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_4"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_4:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_5"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_5:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_6"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_6:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_7"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_7:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_8"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_8:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_9"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_9:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_10"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_10:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_11"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_11:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_12"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_12:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_13"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_13:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_14"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_14:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_15"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_15:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_16"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_16:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_17"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_17:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_18"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_18:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_19"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_19:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_20"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_20:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_21"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_21:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_22"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_22:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_23"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_23:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_24"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_24:globalStore.workStatusYpakovka
            })
            specZopros()
        } else if (e.target.className == "button_adress_25"){
            await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
                id:props.znpData.id,
                address_pallet_25:globalStore.workStatusYpakovka
            })
            specZopros()
        }
    }
    ...
    return (
        <tr onClick={(e)=>{clickPalets(e.target)}}>
                    ...
                    <td>
                        ...
                        <select  className={"addressPallet1"}  onChange={(eventTarget, eventId) => {onChange(eventTarget.target , props.znpData)}}>
                            ...
                            {buffers.map(option=>
                                ...
                                <MyOption key = {option.id} option={option} sector={user.ypakovka} />
                            )}
            ...
            <td >{props.znpData.number_of_pallets_1 == null|| props.znpData.number_of_pallets_1 === 0 ?(
                ...
                <button className={"button_adress_1"} onClick={(e) =>{worckStatus(e, props)}} >Закрыть</button>
           ...
           <td className={"addressPallet2"}  style={pal2}>{props.znpData.number_of_pallets_2 == null || props.znpData.number_of_pallets_2 == 0 ?(
            ...
            <td>{props.znpData.number_of_pallets_2 == null|| props.znpData.number_of_pallets_2 === 0 ?(
                ...
                <button className={"button_adress_2"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            ...
            <td>{props.znpData.number_of_pallets_3 == null|| props.znpData.number_of_pallets_3 === 0 ?(
                ...
                <button className={"button_adress_3"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
           ...
           <td className={"addressPallet4"}  style={pal4}>{props.znpData.number_of_pallets_4 == null || props.znpData.number_of_pallets_4 == 0 ?(
            ...
            <td>{props.znpData.number_of_pallets_4 == null|| props.znpData.number_of_pallets_4 === 0 ?(
                ...
                <button className={"button_adress_4"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            ) }</td>
            ...
            <td>{props.znpData.number_of_pallets_5 == null|| props.znpData.number_of_pallets_5 === 0 ?(
                ...
                <button className={"button_adress_5"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
           ...
           <td className={"addressPallet6"}  style={pal6}>{props.znpData.number_of_pallets_6 == null || props.znpData.number_of_pallets_6 == 0 ?(
            ...
            <td>{props.znpData.number_of_pallets_6 == null|| props.znpData.number_of_pallets_6 === 0 ?(
                ...
                <button className={"button_adress_6"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_7 == null|| props.znpData.number_of_pallets_7 === 0 ?(
                ...
                <button className={"button_adress_7"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_8 == null|| props.znpData.number_of_pallets_8 === 0 ?(
                ...
                <button className={"button_adress_8"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_9 == null|| props.znpData.number_of_pallets_9 === 0 ?(
                ...
                <button className={"button_adress_9"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_10 == null|| props.znpData.number_of_pallets_10 === 0 ?(
                ...
                <button className={"button_adress_10"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_11 == null|| props.znpData.number_of_pallets_11 === 0 ?(
                ...
                <button className={"button_adress_11"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_12 == null|| props.znpData.number_of_pallets_12 === 0 ?(
                ...
                <button className={"button_adress_12"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_13 == null|| props.znpData.number_of_pallets_13 === 0 ?(
                ...
                <button className={"button_adress_13"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_14 == null|| props.znpData.number_of_pallets_14 === 0 ?(
                ...
                <button className={"button_adress_14"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_15 == null|| props.znpData.number_of_pallets_15 === 0 ?(
                ...
                <button className={"button_adress_15"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_16 == null|| props.znpData.number_of_pallets_16 === 0 ?(
                ...
                <button className={"button_adress_16"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
           ...
           <td className={"addressPallet17"}  style={pal17}>{props.znpData.number_of_pallets_17 == null || props.znpData.number_of_pallets_17 == 0 ?(
            ...
            <td>{props.znpData.number_of_pallets_17 == null|| props.znpData.number_of_pallets_17 === 0 ?(
                ...
                <button className={"button_adress_17"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_18 == null|| props.znpData.number_of_pallets_18 === 0 ?(
                ...
                <button className={"button_adress_18"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
           ...
           <td className={"addressPallet19"}  style={pal19}>{props.znpData.number_of_pallets_19 == null || props.znpData.number_of_pallets_19 == 0 ?(
            ...
            <td>{props.znpData.number_of_pallets_19 == null|| props.znpData.number_of_pallets_19 === 0 ?(
                ...
                <button className={"button_adress_19"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_20 == null|| props.znpData.number_of_pallets_20 === 0 ?(
                ...
                <button className={"button_adress_20"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_21 == null|| props.znpData.number_of_pallets_21 === 0 ?(
                ...
                <button className={"button_adress_21"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_22 == null|| props.znpData.number_of_pallets_22 === 0 ?(
                ...
                <button className={"button_adress_22"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_23 == null|| props.znpData.number_of_pallets_23 === 0 ?(
                ...
                <button className={"button_adress_23"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_24 == null|| props.znpData.number_of_pallets_24 === 0 ?(
                ...
                <button className={"button_adress_24"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
            ...
            <td>{props.znpData.number_of_pallets_25 == null|| props.znpData.number_of_pallets_25 === 0 ?(
                ...
                <button className={"button_adress_25"} onClick={(e) =>{worckStatus(e, props)}}>Закрыть</button>
            )}</td>
...
export default ZnpDataItemYpakovka;