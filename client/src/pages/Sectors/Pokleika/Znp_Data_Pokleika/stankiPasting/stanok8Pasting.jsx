...
const Stanok8Pasting = ({znpData,stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet8"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_8 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_8}✔</option>)
...
export default React.memo(Stanok8Pasting);