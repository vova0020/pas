...
const Stanok23Pasting = ({znpData,stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet23"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_23 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_23}✔</option>)
...
export default React.memo(Stanok23Pasting);