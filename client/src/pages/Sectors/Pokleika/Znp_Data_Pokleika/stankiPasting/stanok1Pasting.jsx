...
const Stanok1Pasting = ({znpData,stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet1"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_1 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_1} ✔</option>)
...
export default React.memo(Stanok1Pasting);