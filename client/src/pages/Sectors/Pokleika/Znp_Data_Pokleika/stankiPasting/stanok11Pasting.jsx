...
const Stanok11Pasting = ({znpData,stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet11"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_11 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_11}✔</option>)
...
export default React.memo(Stanok11Pasting);