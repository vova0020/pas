...
const Stanok5Pasting = ({znpData, stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet5"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_5 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_5}✔</option>)
...
export default React.memo(Stanok5Pasting);