...
const Stanok9Pasting = ({znpData,stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet9"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_9 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_9}✔</option>)
...
export default React.memo(Stanok9Pasting);