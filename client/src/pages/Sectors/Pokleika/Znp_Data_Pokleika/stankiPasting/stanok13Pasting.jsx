...
const Stanok13Pasting = ({znpData,stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet13"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_13 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_13}✔</option>)
...
export default React.memo(Stanok13Pasting);