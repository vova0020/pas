...
const Stanok24Pasting = ({znpData,stanckiSpisock, onChangeStanock}) => {
    return (
        <select className={"addressPallet24"} onChange={(eventTarget, eventId, znpDatas) => {
            onChangeStanock(eventTarget.target , znpData)
        }}>
            {znpData.machine_pallet_pasting_24 != null
                ? (<option value="standart">{znpData.machine_pallet_pasting_24}✔</option>)
...
export default React.memo(Stanok24Pasting);