...
import ZnpDataItemPokleika from "./znpData_item_Pokleika";
import StanckiServis from "../../../../API/StanckiServis";
import ModalWindow from "../../modal/ModalWindow";



const ZnpDataTablePokleika = observer(() => {
...
//===================== Блок с переменными ========================================
    ...
    const [stanckiSpisock, setStanckiSpisock] = useState([])

    // Отправка запроса при изменении стора
    useEffect(()=>{
       if (globalStore.znp.id != "") {
           // console.log("Запрос прошел")
           getAllZnpData(globalStore.znp.id, user.pokleika)
...
// Запрос к бд с учетом сектора работы
    ...
    async function getAllStancki (sector){
        const getStancki = await StanckiServis.getAllStancki(sector)
        setStanckiSpisock( getStancki.sort(function (a,b){
            return a.id-b.id
        }))
        ...
        <div>
            ...
            <table className={classes.tableData}>
                ...
                <tr>
                    ...
                    <th className={"th_def"}></th>
                    <th className={"th_def"}></th>
                    <th colSpan={4}>Палет 1</th>
                    <th colSpan={4}>Палет 2</th>
                    <th colSpan={4}>Палет 3</th>
                    <th colSpan={4}>Палет 4</th>
                    <th colSpan={4}>Палет 5</th>
                    <th colSpan={4}>Палет 6</th>
                    <th colSpan={4}>Палет 7</th>
                    <th colSpan={4}>Палет 8</th>
                    <th colSpan={4}>Палет 9</th>
                    <th colSpan={4}>Палет 10</th>
                    <th colSpan={4}>Палет 11</th>
                    <th colSpan={4}>Палет 12</th>
                    <th colSpan={4}>Палет 13</th>
                    <th colSpan={4}>Палет 14</th>
                    <th colSpan={4}>Палет 15</th>
                    <th colSpan={4}>Палет 16</th>
                    <th colSpan={4}>Палет 17</th>
                    <th colSpan={4}>Палет 18</th>
                    <th colSpan={4}>Палет 19</th>
                    <th colSpan={4}>Палет 20</th>
                    <th colSpan={4}>Палет 21</th>
                    <th colSpan={4}>Палет 22</th>
                    <th colSpan={4}>Палет 23</th>
                    <th colSpan={4}>Палет 24</th>
                    <th colSpan={4}>Палет 25</th>
                ...
                {globalStore.znpFilter == true ?(
                    sortedZnpData.map((worckZnpDat) =>
                        (
                            <ZnpDataItemPokleika buffers={buffers} znpData={worckZnpDat} specZopros={specZopros} modalDatas={modalDatas} stanckiSpisock={stanckiSpisock}  key={worckZnpDat.id}  />
                        )
                    )
                ):(
                    <tr></tr>
...
export default React.memo(ZnpDataTablePokleika);