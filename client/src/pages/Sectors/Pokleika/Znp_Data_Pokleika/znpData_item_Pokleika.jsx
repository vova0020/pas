...
const ZnpDataItemPokleika = ({buffers, specZopros,modalDatas, ...props}) => {
    ...
    if (props.znpData.address_pallet_1 != null && props.znpData.address_pallet_1.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_2 != null && props.znpData.address_pallet_2.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_3 != null && props.znpData.address_pallet_3.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_4 != null && props.znpData.address_pallet_4.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_5 != null && props.znpData.address_pallet_5.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_6 != null && props.znpData.address_pallet_6.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_7 != null && props.znpData.address_pallet_7.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_8 != null && props.znpData.address_pallet_8.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_9 != null && props.znpData.address_pallet_9.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_10 != null && props.znpData.address_pallet_10.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_11 != null && props.znpData.address_pallet_11.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_12 != null && props.znpData.address_pallet_12.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_13 != null && props.znpData.address_pallet_13.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_14 != null && props.znpData.address_pallet_14.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_15 != null && props.znpData.address_pallet_15.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_16 != null && props.znpData.address_pallet_16.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_17 != null && props.znpData.address_pallet_17.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_18 != null && props.znpData.address_pallet_18.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_19 != null && props.znpData.address_pallet_19.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_20 != null && props.znpData.address_pallet_20.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_21 != null && props.znpData.address_pallet_21.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_22 != null && props.znpData.address_pallet_22.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_23 != null && props.znpData.address_pallet_23.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_24 != null && props.znpData.address_pallet_24.substring(0,17) === globalStore.workStatusPokleika ||
        props.znpData.address_pallet_25 != null && props.znpData.address_pallet_25.substring(0,17) === globalStore.workStatusPokleika){
...
//=================================  Палет 1  ==============================================================================================================
    if(props.znpData.address_pallet_1 != null && props.znpData.address_pallet_1.substring(0,2) === globalStore.cellA ||
        ...
        pal1 = colorBlue
    } else if (props.znpData.address_pallet_1 != null && props.znpData.address_pallet_1.substring(0,2) === globalStore.cellB ||
        ...
        pal1 = colorClose
    }else if (props.znpData.address_pallet_1 != null && props.znpData.address_pallet_1.substring(0,17) === globalStore.workStatusPokleika){
        pal1 = colorWork
    }
//=================================  Палет 2  ==============================================================================================================
    if(props.znpData.address_pallet_2 != null && props.znpData.address_pallet_2.substring(0,2) === globalStore.cellA ||
        ...
        pal2 = colorBlue
    } else if (props.znpData.address_pallet_2 != null && props.znpData.address_pallet_2.substring(0,2) === globalStore.cellB ||
        ...
        pal2 = colorGrin
    }else if (props.znpData.address_pallet_2 != null && props.znpData.address_pallet_2.substring(0,17) === globalStore.workStatusPokleika){
        pal2 = colorWork
    }
//=================================  Палет 3 ==============================================================================================================
    if(props.znpData.address_pallet_3 != null && props.znpData.address_pallet_3.substring(0,2) === globalStore.cellA ||
        ...
        pal3 = colorBlue
    } else if (props.znpData.address_pallet_3 != null && props.znpData.address_pallet_3.substring(0,2) === globalStore.cellB ||
        ...
        pal3 = colorClose
    }else if (props.znpData.address_pallet_3 != null && props.znpData.address_pallet_3.substring(0,17) === globalStore.workStatusPokleika){
        pal3 = colorWork
    }
//=================================  Палет 4 ==============================================================================================================
    if(props.znpData.address_pallet_4 != null && props.znpData.address_pallet_4.substring(0,2) === globalStore.cellA ||
        ...
        pal4 = colorBlue
    } else if (props.znpData.address_pallet_4 != null && props.znpData.address_pallet_4.substring(0,2) === globalStore.cellB ||
        ...
        pal4 = colorClose
    }else if (props.znpData.address_pallet_4 != null && props.znpData.address_pallet_4.substring(0,17) === globalStore.workStatusPokleika){
        pal4 = colorWork
    }
//=================================  Палет 5 ==============================================================================================================
    if(props.znpData.address_pallet_5 != null && props.znpData.address_pallet_5.substring(0,2) === globalStore.cellA ||
        ...
        pal5 = colorBlue
    } else if (props.znpData.address_pallet_5 != null && props.znpData.address_pallet_5.substring(0,2) === globalStore.cellB ||
        ...
        pal5 = colorClose
    }else if (props.znpData.address_pallet_5 != null && props.znpData.address_pallet_5.substring(0,17) === globalStore.workStatusPokleika){
        pal5 = colorWork
    }
//=================================  Палет 6 ==============================================================================================================
    if(props.znpData.address_pallet_6 != null && props.znpData.address_pallet_6.substring(0,2) === globalStore.cellA ||
        ...
        pal6 = colorBlue
    } else if (props.znpData.address_pallet_6 != null && props.znpData.address_pallet_6.substring(0,2) === globalStore.cellB ||
        ...
        pal6 = colorClose
    }else if (props.znpData.address_pallet_6 != null && props.znpData.address_pallet_6.substring(0,17) === globalStore.workStatusPokleika){
        pal6 = colorWork
    }
//=================================  Палет 7 ==============================================================================================================
    if(props.znpData.address_pallet_7 != null && props.znpData.address_pallet_7.substring(0,2) === globalStore.cellA ||
        ...
        pal7 = colorBlue
    } else if (props.znpData.address_pallet_7 != null && props.znpData.address_pallet_7.substring(0,2) === globalStore.cellB ||
        ...
        pal7 = colorClose
    }else if (props.znpData.address_pallet_7 != null && props.znpData.address_pallet_7.substring(0,17) === globalStore.workStatusPokleika){
        pal7 = colorWork
    }
//=================================  Палет 8 ==============================================================================================================
    if(props.znpData.address_pallet_8 != null && props.znpData.address_pallet_8.substring(0,2) === globalStore.cellA ||
        ...
        pal8 = colorBlue
    } else if (props.znpData.address_pallet_8 != null && props.znpData.address_pallet_8.substring(0,2) === globalStore.cellB ||
        ...
        pal8 = colorClose
    }else if (props.znpData.address_pallet_8 != null && props.znpData.address_pallet_8.substring(0,17) === globalStore.workStatusPokleika){
        pal8 = colorWork
    }
//=================================  Палет 9 ==============================================================================================================
    if(props.znpData.address_pallet_9 != null && props.znpData.address_pallet_9.substring(0,2) === globalStore.cellA ||
        ...
        pal9 = colorBlue
    } else if (props.znpData.address_pallet_9 != null && props.znpData.address_pallet_9.substring(0,2) === globalStore.cellB ||
        ...
        pal9 = colorClose
    }else if (props.znpData.address_pallet_9 != null && props.znpData.address_pallet_9.substring(0,17) === globalStore.workStatusPokleika){
        pal9 = colorWork
    }
//=================================  Палет 10 ==============================================================================================================
    if(props.znpData.address_pallet_10 != null && props.znpData.address_pallet_10.substring(0,2) === globalStore.cellA ||
        ...
        pal10 = colorBlue
    } else if (props.znpData.address_pallet_10 != null && props.znpData.address_pallet_10.substring(0,2) === globalStore.cellB ||
        ...
        pal10 = colorClose
    }else if (props.znpData.address_pallet_10 != null && props.znpData.address_pallet_10.substring(0,17) === globalStore.workStatusPokleika){
        pal10 = colorWork
    }
//=================================  Палет 11 ==============================================================================================================
    if(props.znpData.address_pallet_11 != null && props.znpData.address_pallet_11.substring(0,2) === globalStore.cellA ||
        ...
        pal11 = colorBlue
    } else if (props.znpData.address_pallet_11 != null && props.znpData.address_pallet_11.substring(0,2) === globalStore.cellB ||
        ...
        pal11 = colorClose
    }else if (props.znpData.address_pallet_11 != null && props.znpData.address_pallet_11.substring(0,17) === globalStore.workStatusPokleika){
        pal11 = colorWork
    }
//=================================  Палет 12 ==============================================================================================================
    if(props.znpData.address_pallet_12 != null && props.znpData.address_pallet_12.substring(0,2) === globalStore.cellA ||
        ...
        pal12 = colorBlue
    } else if (props.znpData.address_pallet_12 != null && props.znpData.address_pallet_12.substring(0,2) === globalStore.cellB ||
        ...
        pal12 = colorClose
    }else if (props.znpData.address_pallet_12 != null && props.znpData.address_pallet_12.substring(0,17) === globalStore.workStatusPokleika){
        pal12 = colorWork
    }
//=================================  Палет 13 ==============================================================================================================
    if(props.znpData.address_pallet_13 != null && props.znpData.address_pallet_13.substring(0,2) === globalStore.cellA ||
        ...
        pal13 = colorBlue
    } else if (props.znpData.address_pallet_13 != null && props.znpData.address_pallet_13.substring(0,2) === globalStore.cellB ||
        ...
        pal13 = colorClose
    }else if (props.znpData.address_pallet_13 != null && props.znpData.address_pallet_13.substring(0,17) === globalStore.workStatusPokleika){
        pal13 = colorWork
    }
//=================================  Палет 14 ==============================================================================================================
    if(props.znpData.address_pallet_14 != null && props.znpData.address_pallet_14.substring(0,2) === globalStore.cellA ||
        ...
        pal14 = colorBlue
    } else if (props.znpData.address_pallet_14 != null && props.znpData.address_pallet_14.substring(0,2) === globalStore.cellB ||
        ...
        pal14 = colorClose
    }else if (props.znpData.address_pallet_14 != null && props.znpData.address_pallet_14.substring(0,17) === globalStore.workStatusPokleika){
        pal14 = colorWork
    }
//=================================  Палет 15 ==============================================================================================================
    if(props.znpData.address_pallet_15 != null && props.znpData.address_pallet_15.substring(0,2) === globalStore.cellA ||
        ...
        pal15 = colorBlue
    } else if (props.znpData.address_pallet_15 != null && props.znpData.address_pallet_15.substring(0,2) === globalStore.cellB ||
        ...
        pal15 = colorClose
    }else if (props.znpData.address_pallet_15 != null && props.znpData.address_pallet_15.substring(0,17) === globalStore.workStatusPokleika){
        pal15 = colorWork
    }
//=================================  Палет 16 ==============================================================================================================
    if(props.znpData.address_pallet_16 != null && props.znpData.address_pallet_16.substring(0,2) === globalStore.cellA ||
        ...
        pal16 = colorBlue
    } else if (props.znpData.address_pallet_16 != null && props.znpData.address_pallet_16.substring(0,2) === globalStore.cellB ||
        ...
        pal16 = colorClose
    }else if (props.znpData.address_pallet_16 != null && props.znpData.address_pallet_16.substring(0,17) === globalStore.workStatusPokleika){
        pal16 = colorWork
    }
//=================================  Палет 17 ==============================================================================================================
    if(props.znpData.address_pallet_17 != null && props.znpData.address_pallet_17.substring(0,2) === globalStore.cellA ||
        ...
        pal17 = colorBlue
    } else if (props.znpData.address_pallet_17 != null && props.znpData.address_pallet_17.substring(0,2) === globalStore.cellB ||
        ...
        pal17 = colorClose
    }else if (props.znpData.address_pallet_17 != null && props.znpData.address_pallet_17.substring(0,17) === globalStore.workStatusPokleika){
        pal17 = colorWork
    }
//=================================  Палет 18 ==============================================================================================================
    if(props.znpData.address_pallet_18 != null && props.znpData.address_pallet_18.substring(0,2) === globalStore.cellA ||
        ...
        pal18 = colorBlue
    } else if (props.znpData.address_pallet_18 != null && props.znpData.address_pallet_18.substring(0,2) === globalStore.cellB ||
        ...
        pal18 = colorClose
    }else if (props.znpData.address_pallet_18 != null && props.znpData.address_pallet_18.substring(0,17) === globalStore.workStatusPokleika){
        pal18 = colorWork
    }
//=================================  Палет 19 ==============================================================================================================
    if(props.znpData.address_pallet_19 != null && props.znpData.address_pallet_19.substring(0,2) === globalStore.cellA ||
        ...
        pal19 = colorBlue
    } else if (props.znpData.address_pallet_19 != null && props.znpData.address_pallet_19.substring(0,2) === globalStore.cellB ||
        ...
        pal19 = colorClose
    }else if (props.znpData.address_pallet_19 != null && props.znpData.address_pallet_19.substring(0,17) === globalStore.workStatusPokleika){
        pal19 = colorWork
    }
//=================================  Палет 20 ==============================================================================================================
    if(props.znpData.address_pallet_20 != null && props.znpData.address_pallet_20.substring(0,2) === globalStore.cellA ||
        ...
        pal20 = colorBlue
    } else if (props.znpData.address_pallet_20 != null && props.znpData.address_pallet_20.substring(0,2) === globalStore.cellB ||
        ...
        pal20 = colorClose
    }else if (props.znpData.address_pallet_20 != null && props.znpData.address_pallet_20.substring(0,17) === globalStore.workStatusPokleika){
        pal20 = colorWork
    }
//=================================  Палет 21 ==============================================================================================================
    if(props.znpData.address_pallet_21 != null && props.znpData.address_pallet_21.substring(0,2) === globalStore.cellA ||
        ...
        pal21 = colorBlue
    } else if (props.znpData.address_pallet_21 != null && props.znpData.address_pallet_21.substring(0,2) === globalStore.cellB ||
        ...
        pal21 = colorClose
    }else if (props.znpData.address_pallet_21 != null && props.znpData.address_pallet_21.substring(0,17) === globalStore.workStatusPokleika){
        pal21 = colorWork
    }
//=================================  Палет 22 ==============================================================================================================
    if(props.znpData.address_pallet_22 != null && props.znpData.address_pallet_22.substring(0,2) === globalStore.cellA ||
        ...
        pal22 = colorBlue
    } else if (props.znpData.address_pallet_22 != null && props.znpData.address_pallet_22.substring(0,2) === globalStore.cellB ||
        ...
        pal22 = colorClose
    }else if (props.znpData.address_pallet_22 != null && props.znpData.address_pallet_22.substring(0,17) === globalStore.workStatusPokleika){
        pal22 = colorWork
    }
//=================================  Палет 23 ==============================================================================================================
    if(props.znpData.address_pallet_23 != null && props.znpData.address_pallet_23.substring(0,2) === globalStore.cellA ||
        ...
        pal23 = colorBlue
    } else if (props.znpData.address_pallet_23 != null && props.znpData.address_pallet_23.substring(0,2) === globalStore.cellB ||
        ...
        pal23 = colorClose
    }else if (props.znpData.address_pallet_23 != null && props.znpData.address_pallet_23.substring(0,17) === globalStore.workStatusPokleika){
        pal23 = colorWork
    }
//=================================  Палет 24 ==============================================================================================================
    if(props.znpData.address_pallet_24 != null && props.znpData.address_pallet_24.substring(0,2) === globalStore.cellA ||
        ...
        pal24 = colorBlue
    } else if (props.znpData.address_pallet_24 != null && props.znpData.address_pallet_24.substring(0,2) === globalStore.cellB ||
        ...
        pal24 = colorClose
    }else if (props.znpData.address_pallet_24 != null && props.znpData.address_pallet_24.substring(0,17) === globalStore.workStatusPokleika){
        pal24 = colorWork
    }
//=================================  Палет 25 ==============================================================================================================
    if(props.znpData.address_pallet_25 != null && props.znpData.address_pallet_25.substring(0,2) === globalStore.cellA ||
        ...
        pal25 = colorBlue
    } else if (props.znpData.address_pallet_25 != null && props.znpData.address_pallet_25.substring(0,2) === globalStore.cellB ||
        ...
        pal25 = colorClose
    }else if (props.znpData.address_pallet_25 != null && props.znpData.address_pallet_25.substring(0,17) === globalStore.workStatusPokleika){
        pal25 = colorWork
    }
...
//=================================  Палет 1  ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_1 != null && props.znpData.machine_pallet_pasting_1.substring(0,7) === globalStore.readyStatusStanock){
        pal1Good = colorGrin
    }
//=================================  Палет 2  ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_2 != null && props.znpData.machine_pallet_pasting_2.substring(0,7) === globalStore.readyStatusStanock){
        pal2Good = colorGrin
    }
//=================================  Палет 3 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_3 != null && props.znpData.machine_pallet_pasting_3.substring(0,7) === globalStore.readyStatusStanock){
        pal3Good = colorGrin
    }
//=================================  Палет 4 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_4 != null && props.znpData.machine_pallet_pasting_4.substring(0,7) === globalStore.readyStatusStanock){
        pal4Good = colorGrin
    }
//=================================  Палет 5 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_5 != null && props.znpData.machine_pallet_pasting_5.substring(0,7) === globalStore.readyStatusStanock){
        pal5Good = colorGrin
    }
//=================================  Палет 6 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_6 != null && props.znpData.machine_pallet_pasting_6.substring(0,7) === globalStore.readyStatusStanock){
        pal6Good = colorGrin
    }
//=================================  Палет 7 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_7 != null && props.znpData.machine_pallet_pasting_7.substring(0,7) === globalStore.readyStatusStanock){
        pal7Good = colorGrin
    }
//=================================  Палет 8 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_8 != null && props.znpData.machine_pallet_pasting_8.substring(0,7) === globalStore.readyStatusStanock){
        pal8Good = colorGrin
    }
//=================================  Палет 9 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_9 != null && props.znpData.machine_pallet_pasting_9.substring(0,7) === globalStore.readyStatusStanock){
        pal9Good = colorGrin
    }
//=================================  Палет 10 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_10 != null && props.znpData.machine_pallet_pasting_10.substring(0,7) === globalStore.readyStatusStanock){
        pal10Good = colorGrin
    }
//=================================  Палет 11 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_11 != null && props.znpData.machine_pallet_pasting_11.substring(0,7) === globalStore.readyStatusStanock){
        pal11Good = colorGrin
    }
//=================================  Палет 12 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_12 != null && props.znpData.machine_pallet_pasting_12.substring(0,7) === globalStore.readyStatusStanock){
        pal12Good = colorGrin
    }
//=================================  Палет 13 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_13 != null && props.znpData.machine_pallet_pasting_13.substring(0,7) === globalStore.readyStatusStanock){
        pal13Good = colorGrin
    }
//=================================  Палет 14 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_14 != null && props.znpData.machine_pallet_pasting_14.substring(0,7) === globalStore.readyStatusStanock){
        pal14Good = colorGrin
    }
//=================================  Палет 15 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_15 != null && props.znpData.machine_pallet_pasting_15.substring(0,7) === globalStore.readyStatusStanock){
        pal15Good = colorGrin
    }
//=================================  Палет 16 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_16 != null && props.znpData.machine_pallet_pasting_16.substring(0,7) === globalStore.readyStatusStanock){
        pal16Good = colorGrin
    }
//=================================  Палет 17 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_17 != null && props.znpData.machine_pallet_pasting_17.substring(0,7) === globalStore.readyStatusStanock){
        pal17Good = colorGrin
    }
//=================================  Палет 18 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_18 != null && props.znpData.machine_pallet_pasting_18.substring(0,7) === globalStore.readyStatusStanock){
        pal18Good = colorGrin
    }
//=================================  Палет 19 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_19 != null && props.znpData.machine_pallet_pasting_19.substring(0,7) === globalStore.readyStatusStanock){
        pal19Good = colorGrin
    }
//=================================  Палет 20 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_20 != null && props.znpData.machine_pallet_pasting_20.substring(0,7) === globalStore.readyStatusStanock){
        pal20Good = colorGrin
    }
//=================================  Палет 21 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_21 != null && props.znpData.machine_pallet_pasting_21.substring(0,7) === globalStore.readyStatusStanock){
        pal21Good = colorGrin
    }
//=================================  Палет 22 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_22 != null && props.znpData.machine_pallet_pasting_22.substring(0,7) === globalStore.readyStatusStanock){
        pal22Good = colorGrin
    }
//=================================  Палет 23 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_23 != null && props.znpData.machine_pallet_pasting_23.substring(0,7) === globalStore.readyStatusStanock){
        pal23Good = colorGrin
    }
//=================================  Палет 24 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_24 != null && props.znpData.machine_pallet_pasting_24.substring(0,7) === globalStore.readyStatusStanock){
        pal24Good = colorGrin
    }
//=================================  Палет 25 ==============================================================================================================
    if(props.znpData.machine_pallet_pasting_25 != null && props.znpData.machine_pallet_pasting_25.substring(0,7) === globalStore.readyStatusStanock){
        pal25Good = colorGrin
    }
...
async function worckStatus(e, props){
    if (e.target.className == "button_adress_1"){
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_1:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_2"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_2:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_3"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_3:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_4"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_4:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_5"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_5:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_6"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_6:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_7"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_7:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_8"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_8:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_9"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_9:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_10"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_10:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_11"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_11:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_12"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_12:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_13"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_13:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_14"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_14:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_15"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_15:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_16"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_16:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_17"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_17:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_18"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_18:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_19"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_19:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_20"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_20:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_21"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_21:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_22"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_22:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_23"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_23:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_24"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_24:globalStore.workStatusPokleika
        })
        specZopros()
    } else if (e.target.className == "button_adress_25"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:props.znpData.id,
            address_pallet_25:globalStore.workStatusPokleika
        })
        specZopros()
    }
}
...
async function onChangeStanock(eventTarget, eventId){
    if (eventTarget.className == "addressPalletStanock1"){
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_1:eventTarget.selectedOptions[0].text
        })
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_2:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_3:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_4:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_5:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_6:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_7:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_8:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_9:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_10:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_11:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_12:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_13:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_14:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_15:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_16:eventTarget.selectedOptions[0].text
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_17:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_18:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_19:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_20:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_21:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_22:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_23:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_24:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
        ...
        await axios.put( process.env.REACT_APP_ZNPDATA_URL,{
            id:eventId.id,
            machine_pallet_pasting_25:eventTarget.selectedOptions[0].text
        })
        // Добавляем данные в таблицу станков
        await axios.post(process.env.REACT_APP_STANCKI_ZNP_URL,{
            stanock:eventTarget.selectedOptions[0].text,
...
{/*========================================  Палет   ====================================================================================================================================================*/}
           ...
           {/*<td>{props.znpData.address_pallet_1}✔</td>*/}
                ...
                activSelect1 ?(
                    <td>
                        ...
                        <select  className={"addressPallet1"}  onChange={(eventTarget, eventId) => {onChange(eventTarget.target , props.znpData)}}>
                            <option selected="true" disabled="disabled">Выберете адрес!</option>

                            {buffers.map(option=>

                                <MyOption key = {option.id} option={option} sector={user.pokleika} />
                            )}
            ...
            <td style={pal1Good}>{props.znpData.number_of_pallets_1 == null || props.znpData.number_of_pallets_1 == 0 ?(
                ...
                <select className={"addressPalletStanock1"} onChange={(eventTarget, eventId) => {
                    onChangeStanock(eventTarget.target , props.znpData)
                }}>
                    {props.znpData.machine_pallet_pasting_1 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_1} ✔</option>)
 ...
 {/*========================================  Палет   ====================================================================================================================================================*/}
            ...
            <td style={pal2Good}>{props.znpData.number_of_pallets_2 == null || props.znpData.number_of_pallets_2 == 0 ?(
                ...
                <select className={"addressPalletStanock2"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_2 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_2} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*========================================  Палет   ====================================================================================================================================================*/}
            ...
            <td style={pal3Good}>{props.znpData.number_of_pallets_3 == null || props.znpData.number_of_pallets_3 == 0 ?(
                ...
                <select className={"addressPalletStanock3"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_3 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_3} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*========================================  Палет   ====================================================================================================================================================*/}
            ...
            <td style={pal4Good}>{props.znpData.number_of_pallets_4 == null || props.znpData.number_of_pallets_4 == 0 ?(
                ...
                <select className={"addressPalletStanock4"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_4 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_4} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal5Good}>{props.znpData.number_of_pallets_5 == null || props.znpData.number_of_pallets_5 == 0 ?(
                ...
                <select className={"addressPalletStanock5"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_5 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_5} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal6Good}>{props.znpData.number_of_pallets_6 == null || props.znpData.number_of_pallets_6 == 0 ?(
                ...
                <select className={"addressPalletStanock6"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_6 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_6} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal7Good}>{props.znpData.number_of_pallets_7 == null || props.znpData.number_of_pallets_7 == 0 ?(
                ...
                <select className={"addressPalletStanock7"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_7 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_7} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal8Good}>{props.znpData.number_of_pallets_8 == null || props.znpData.number_of_pallets_8 == 0 ?(
                ...
                <select className={"addressPalletStanock8"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_8 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_8} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal9Good}>{props.znpData.number_of_pallets_9 == null || props.znpData.number_of_pallets_9 == 0 ?(
                ...
                <select className={"addressPalletStanock9"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_9 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_9} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal10Good}>{props.znpData.number_of_pallets_10 == null || props.znpData.number_of_pallets_10 == 0 ?(
                ...
                <select className={"addressPalletStanock10"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_10 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_10} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal11Good}>{props.znpData.number_of_pallets_11 == null || props.znpData.number_of_pallets_11 == 0 ?(
                ...
                <select className={"addressPalletStanock11"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_11 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_11} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal12Good}>{props.znpData.number_of_pallets_12 == null || props.znpData.number_of_pallets_12 == 0 ?(
                ...
                <select className={"addressPalletStanock12"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_12 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_12} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal13Good}>{props.znpData.number_of_pallets_13 == null || props.znpData.number_of_pallets_13 == 0 ?(
                ...
                <select className={"addressPalletStanock13"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_13 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_13} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal14Good}>{props.znpData.number_of_pallets_14 == null || props.znpData.number_of_pallets_14 == 0 ?(
                ...
                <select className={"addressPalletStanock14"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_14 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_14} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal15Good}>{props.znpData.number_of_pallets_15 == null || props.znpData.number_of_pallets_15 == 0 ?(
                ...
                <select className={"addressPalletStanock15"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_15 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_15} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal16Good}>{props.znpData.number_of_pallets_16 == null || props.znpData.number_of_pallets_16 == 0 ?(
                ...
                <select className={"addressPalletStanock16"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_16 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_16} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal17Good}>{props.znpData.number_of_pallets_17 == null || props.znpData.number_of_pallets_17 == 0 ?(
                ...
                <select className={"addressPalletStanock17"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_17 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_17} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal18Good}>{props.znpData.number_of_pallets_18 == null || props.znpData.number_of_pallets_18 == 0 ?(
                ...
                <select className={"addressPalletStanock18"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_18 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_18} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal19Good}>{props.znpData.number_of_pallets_19 == null || props.znpData.number_of_pallets_19 == 0 ?(
                ...
                <select className={"addressPalletStanock19"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_19 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_19} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal20Good}>{props.znpData.number_of_pallets_20 == null || props.znpData.number_of_pallets_20 == 0 ?(
                ...
                <select className={"addressPalletStanock20"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_20 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_20} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal21Good}>{props.znpData.number_of_pallets_21 == null || props.znpData.number_of_pallets_21 == 0 ?(
                ...
                <select className={"addressPalletStanock21"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_21 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_21} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal22Good}>{props.znpData.number_of_pallets_22 == null || props.znpData.number_of_pallets_22 == 0 ?(
                ...
                <select className={"addressPalletStanock22"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_22 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_22} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal23Good}>{props.znpData.number_of_pallets_23 == null || props.znpData.number_of_pallets_23 == 0 ?(
                ...
                <select className={"addressPalletStanock23"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_23 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_23} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal24Good}>{props.znpData.number_of_pallets_24 == null || props.znpData.number_of_pallets_24 == 0 ?(
                ...
                <select className={"addressPalletStanock24"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_24 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_24} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
 ...
 {/*/!*========================================  Палет   ====================================================================================================================================================*!/*/}
            ...
            <td style={pal25Good}>{props.znpData.number_of_pallets_25 == null || props.znpData.number_of_pallets_25 == 0 ?(
                ...
                <select className={"addressPalletStanock25"} onChange={(eventTarget, eventId, znpDatas) => {
                    ...
                    {props.znpData.machine_pallet_pasting_25 != null
                        ? (<option value="standart">{props.znpData.machine_pallet_pasting_25} ✔</option>)
                        :(<option value="">Выбрать станок</option>)
                    }
                    {props.stanckiSpisock.map(mashine=>
                        <option value={mashine.stanock} key={Math.random()}>{mashine.stanock}</option>
...
export default React.memo(ZnpDataItemPokleika);