...
const MyPrintTest= ({componentRef, printsClass ,prints, optionOperator,...props}) => {
...
// console.log(prints.number_opening)
    return (
        <div ref={componentRef}  className={printsClass} className={activ ? "modal activ" : "modal"}>
            <div className={classes.myPrint_blocks}>
                ...
                <table className={classes.table_context}>
                    ...
                    <tr>
                        ...
                        <td className={classes.myPrint_footer_text}>{prints.gluing_scheme + " " + prints.groove}</td>
                    </tr>
                    <tr>
                ...
                <table className={classes.myPrint_table}>
                    ...
                    <tr>
                        <td className={classes.TD}>Присадка</td>
                        <td className={classes.TD}></td>
                        <td className={classes.TD}></td>
                        <td className={classes.TD}></td>
                        <td className={classes.TD}></td>
...
export default React.memo(MyPrintTest);